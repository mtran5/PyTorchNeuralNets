...
def generate_segmentation_images(size=224):
    image = random_shapes((size, size), min_shapes=2, max_shapes=8, intensity_range=((0, 127),), shape="ellipse", min_size=20, allow_overlap=True)
...
class SegmentationDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        X, y = generate_segmentation_images()
